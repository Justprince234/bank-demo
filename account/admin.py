...
class UserAdmin(BaseUserAdmin):
    fieldsets = (
        (None, {'fields': ('status','email', 'first_name', 'middle_name', 'surname', 'date_of_birth', 'phone', 'address', 'account_number', 'scheduled_balance', 'expenses_balance', 'password', 'last_login')}),
        ('Permissions', {'fields': (
            'is_active',
            'is_staff',
            'is_superuser',
